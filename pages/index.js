...
export default function Home() {
    const [bgPath, setBgPath] = useState("/imgs/background.jpeg");
    const [titlePath, setTitlePath] = useState("/imgs/TitleScreen.png");
    useEffect(() => {
        if (typeof window !== "undefined") {
            setBgPath(window.location.origin.toLowerCase().includes("github.io") ? "/SpeedrunTools/imgs/background.jpeg" : "/imgs/background.jpeg");
            setTitlePath(window.location.origin.toLowerCase().includes("github.io") ? "/SpeedrunTools/imgs/TitleScreen.png" : "/imgs/TitleScreen.png");
        }
    }, []);
    return (
        <>
            ...
            <div className="absolute w-full h-full bg-gray-100 overflow-hidden">
                ...
                <div className="w-full h-full flex flex-col justify-center items-center text-gray-200">
                    <div className="w-full h-full brightness-50 bg-cover bg-center" style={{backgroundImage: `url(${bgPath})`}}/>
                    <div className="absolute w-full h-full flex flex-col justify-center items-center p-8 py-16 gap-2">
                    <div className="w-full h-40 bg-contain bg-center bg-no-repeat" style={{backgroundImage: `url(${titlePath})`}} />
                    ...
                    <h1 className="text-white text-lg">Maintained By: DeathHound6</h1>
                    </div>
                </div>
                </MainContainer>
            </div>
